...
class ApiController extends BaseController
{
    ...
    public function GetServicesPricesAndAvailability()
    {
        ...
        if ($validator->fails()) {
            ...
            $response = $this->apiService->collectServicePrices($requestData['IncomingRequest']['SERVICEIDs'], $requestData['IncomingRequest']['START_DATE'], $endDate, $requestData['IncomingRequest']["CURRENCY"])
