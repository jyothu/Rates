...
class ServiceRulesHelper extends ServiceRulesHelperBase
{
     ...
     */
    public function __construct(DateHelper $DateHelper, \Itinerary $Itinerary)
    {
    ...
    public function getRulesBysingleService($datas)
    {
        $requestArray = array();
    ...
    public function prepareErrorMessages($data)
    {
        ...
        foreach ($data as $key => $value) {
            if (property_exists($value, 'rule_name') && $value->rule_name) {
